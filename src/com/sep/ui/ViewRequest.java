...
public class ViewRequest extends javax.swing.JFrame {
    ...
    public void openFile() {
        try {
            scan = new Scanner(new File("updated.txt"));
        } // end try
    ...
    public void displayUpdate() {
        ...
        String desc, status, pref, detail = "", other;
        txtRecord.setText(Integer.toString(scan.nextInt()));
        txtFname.setText(scan.next());
        txtEvent.setText(scan.next());
        for (int i = 0; i <= 20; ++i) {
            desc = scan.next();
            detail = detail + " " + desc;
            if (desc.equals("end")) {
        ...
        txtAtendee.setText(Integer.toString(scan.nextInt()));
        txtBudget.setText(Double.toString(scan.nextDouble()));
        txtFrom.setText(scan.next());
        txtTo.setText(scan.next());
        status = scan.next();
        disableTexts();
        ...
        if (pref.contains("Filming/Photo")) {
            detail = "";
        ...
        if (pref.contains("Poster/Art_Works")) {
            detail = "";
            cmboxPoster.setSelected(true);
            for (int j = 0; j <= 100; ++j) {
                pref = scan.next();
                detail = detail + " " + pref;
                if (pref.contains("end")) {
                    ...
                    txtAreaPoster.setText(detail);
                    txtAreaPoster.setEditable(false);
                }
            }
            pref = scan.next();
        }
        ...
        if (pref.contains("Music")) {
            ...
            for (int j = 0; j <= 100; ++j) {
                ...
                if (pref.contains("end")) {
                    ...
                    txtAreaMusic.setText(detail);
                    txtAreaMusic.setEditable(false);
                }
            }
            pref = scan.next();
        }
        if (pref.contains("Computer_Related_Issues")) {
            detail = "";
            cmboxComp.setSelected(true);
            for (int j = 0; j <= 100; ++j) {
                pref = scan.next();
                detail = detail + " " + pref;
                if (pref.contains("end")) {
                    ...
                    txtAreaComp.setText(detail);
                    txtAreaComp.setEditable(false);
                }
            }
        }
        detail = "";
    ...
    private void initComponents() {
        ...
        cmboxPoster.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmboxPosterActionPerformed(evt);
            }
        });
    ...
    private void cmboxPosterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmboxPosterActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmboxPosterActionPerformed
