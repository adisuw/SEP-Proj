...
public class HRView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblHR.setBackground(new java.awt.Color(204, 204, 204));
        tblHR.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        tblHR.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Contract Type", "Requester", "Experience", "Title", "Description"
            }
        ));
        jScrollPane1.setViewportView(tblHR);

        jButton1.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jButton1.setText("Publish Anouncement");

        jButton2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jButton2.setText("Outsource Job");
